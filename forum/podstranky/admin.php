...
<div class="container-fluid">
	<a class="navbar-brand" href="podstranky/register.php">
    ...
    <div class="collapse navbar-collapse" id="mynavbar">
      <ul class="navbar-nav me-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="javascript:void(0)">Pridaj</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="javascript:void(0)">Odstráň</a>
        </li>
		<li class="nav-item">
          <a class="nav-link" href="javascript:void(0)">Odhás sa!</a>
        </li>
      </ul>
      <form class="d-flex">
        <input class="form-control me-2" type="text" placeholder="Hľadaj">
        <button class="btn btn-primary" type="button">Hľadaj</button>
      </form>
    </div>
  </div>
</nav
