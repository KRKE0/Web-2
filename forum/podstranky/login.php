            ...
            <div class="card-body p-5">
              ...
              <form>
                ...
                <div class="d-flex justify-content-center">
                  <button type="button"
                    class="btn btn-outline-primary btn-block btn-lg gradient-custom-4 text-body">Prihláste sa!</button>
                </div>
                ...
                <p class="text-center text-muted mt-5 mb-0">Nemáte účet? <a href="../podstranky/register.php"
